                    ...
                    <div className="flex justify-between h-16">
                        ...
                        <div className="hidden sm:flex sm:items-center sm:space-x-8">
                            ...
                            <div className="flex space-x-4">
                                <a href={personalInfo.socialDetails.github} target="_blank" className="text-gray-500 hover:text-gray-700">
                                    <Github size={20} />
                                </a>
                                <a href={personalInfo.socialDetails.linkedin} target="_blank" className="text-gray-500 hover:text-gray-700">
                                    <Linkedin size={20} />
                                </a>
                                <a href={personalInfo.socialDetails.mail} target="_blank" className="text-gray-500 hover:text-gray-700">
                                    <Mail size={20} />
                                </a>
                            </div>
                        </div>
            ...
            <section id="experience" className="py-16">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    ...
                    <div className="space-y-8">
                        {work.map((job, index) => (
                            <div key={index} className="bg-white rounded-lg p-6 shadow-sm hover:shadow-md transition-shadow mt-8">
            ...
            <footer className="bg-white border-t">
                <div className="max-w-7xl mx-auto py-8 px-4 sm:px-6 lg:px-8">
                    <div className="flex justify-center space-x-6">
                        <a href={personalInfo.socialDetails.github} target="_blank" className="text-gray-400 hover:text-gray-500">
                            <Github size={20} />
                        </a>
                        <a href={personalInfo.socialDetails.linkedin} target="_blank" className="text-gray-400 hover:text-gray-500">
                            <Linkedin size={20} />
                        </a>
                        <a href={personalInfo.socialDetails.mail} target="_blank" className="text-gray-400 hover:text-gray-500">
                            <Mail size={20} />
                        </a>
                    </div>
                    <p className="mt-4 text-center text-gray-500">
                        © 2025 {personalInfo.name}. All rights reserved | Built with <span className="text-red-500">♥</span> with the help of <a className="underline text-[#DA7756]" target="_blank" href="https://claude.ai">Claude AI</a> | <a className="underline hover:text-blue-600" target="_blank" href={personalInfo.portfolioSourceCode}>&lt;Source Code/&gt;</a>
                    </p>
                </div>
            </footer>
        </div>
